// src/app/data/ubigeo.data.ts

export const UBIGEO_PERU: Record<string, Record<string, string[]>> = {
  "AMAZONAS": {
    "CHACHAPOYAS": ["CHACHAPOYAS", "ASIPULO", "CHETO", "CHILIQUIN", "CHUQUIBAMBA", "GRANADA", "HUANCAS", "LA JALCA", "LEIMEBAMBA", "LEVANTO", "MAGDALENA", "MARISCAL CASTILLA", "MOLINOPAMPA", "MONTEVIDEO", "OLLEROS", "QUINJALCA", "SAN FRANCISCO DE DAGUAS", "SAN ISIDRO DE MAINO", "SOLOCO", "SONCHE", "VALERA"],
  ...
  "ANCASH": {
    ...
    "ANTONIO RAIMONDI": ["LLAMELLIN", "ACZO", "CHACCHO", "CHINGAS", "MIRGAS", "SAN JUAN DE RONTOY"],
    "ASUNCION": ["CHACAS", "ACOCHACA"],
    "BOLOGNESI": ["CHIQUIAN", "ABELARDO PARDO LEZAMETA", "ANTONIO RAIMONDI", "AQUIA", "CAJACAY", "CANIS", "COLQUIOC", "HUALLANCA", "HUASTA", "HUAYLLACAYAN", "LA PRIMAVERA", "MANGAS", "PACLLON", "SAN MIGUEL DE CORPANQUI", "TICLLOS"],
  ...
  "APURIMAC": {
    ...
    "ANDAHUAYLAS": ["ANDAHUAYLAS", "ANDARAPA", "CHIARA", "HUANCARAMA", "HUANCARAY", "HUAYANA", "KISHUARA", "PACOBAMBA", "PACUCHA", "PAMPACHIRI", "POMACOCHA", "SAN ANTONIO DE CACHI", "SAN JERONIMO", "SAN MIGUEL DE CHACCRAMPA", "SANTA MARIA DE CHICMO", "TALAVERA", "TUMAY HUARACA", "TURPO"],
  ...
  "AYACUCHO": {
    ...
    "PARINACOCHAS": ["CORACORA", "CHUMPI", "CORONEL CASTAÑEDA", "PACAPAUSA", "PULLLO", "PUYUSCA", "SAN FRANCISCO DE RAVACAYCO", "UPAHUACHO"],
  ...
  "CUSCO": {
    ...
    "ESPINAR": ["YANAOCA", "CONDOROMA", "COPORAQUE", "OCORURO", "PALLPATA", "PICHIGUA", "SUYCKUTAMBO", "ALTO PICHIGUA"],
  ...
  "HUANCAVELICA": {
    "HUANCAVELICA": ["HUANCAVELICA", "ACOBAMBILLA", "ACORIA", "CONAYCA", "CUENCA", "HUACHOCOLPA", "HUAYLLAHUARA", "IZCUCHACA", "LARIA", "MANTA", "MARISCAL CACERES", "MOYA", "NUEVO OCCORO", "PALCA", "PILCHACA", "VILCA", "YAULI", "ASCENSION"],
  ...
  "HUANUCO": {
    ...
    "LEONCIO PRADO": ["RUPA-RUPA", "DANIEL ALOMIA ROBLES", "HERMILIO VALDIZAN", "JOSE CRESPO Y CASTILLO", "LUYANDO", "MARIANO DAMASO BERAUN"],
    "MARAÑON": ["HUACRACHUCO", "CHOLON", "SAN BUENAVENTURA"],
  ...
  "PUNO": {
    ...
    "AZANGARO": ["AZANGARO", "ACHAYA", "ARAPA", "ASILLO", "CAMINACA", "CHUPA", "JOSE DOMINGO CHOQUEHUANCA", "MUÑANI", "POTONI", "SAMAN", "SAN ANTONIO", "SAN JOSE", "SAN JUAN DE SALINAS", "SANTIAGO DE PUPUJA", "TIRAPATA"],
  ...
  "SAN MARTIN": {
    "MOYOBAMBA": ["MOYOBAMBA", "CALZADA", "HABANA", "JEPEROS", "SORITOR", "YANTALO"],
